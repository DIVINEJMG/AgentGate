...
import type { CredentialReveal } from './agentApi';
...
export interface QuickStartResult{workerId:string;jobIds:string[];identity?:{agentId:string;createdAutomatically:boolean;credential?:CredentialReveal|null};readiness:{state:'started'|'needs_setup';blockers:string[];workerId:string;jobIds:string[]}}
