...
## Context
AgentGate must reconstruct who or what initiated an action, the resource involved, the policy/approval path, and the final provider result. Foundation 7 already establishes correlation IDs, but no unified event ledger existed.
