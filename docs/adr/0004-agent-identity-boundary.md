...
## Context
AgentGate exists to supervise non-human workers. Reusing a human owner session or storing recoverable agent secrets would collapse the trust boundary the product is intended to enforce.
